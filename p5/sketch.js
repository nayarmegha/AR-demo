...
function draw() {
  ...
  if (markerHiro.isVisible() == true) {
    ...
    fill(230, 236, 247);
    noStroke();
    ellipse(hPos.x, hPos.y, 100);
    fill(255);
    ellipse(hPos.x, hPos.y, 50);
    strokeWeight(5);
    stroke("orange")
    line(hPos.x + 20, hPos.y +20, hPos.x+15, hPos.y+15);
    stroke(0)

    line(hPos.x+20, hPos.y+5 , hPos.x+20, hPos.y+5);
    line(hPos.x+5, hPos.y+20 , hPos.x+5, hPos.y+20);
